...
final class FLTheme {
	...
	static public function logo() {
		...
		if ( 'image' == $logo_type ) {
			...
			echo '<video muted loop autoplay class="fl-logo-img" style="max-height:51px;"><source src="/wp-content/uploads/2016/08/logo-asenine-nav.mp4" type="video/mp4"></video>';
			
			// Below is the old code for if a normal logo is required. Above is the video replacement for the logo.
